                    ...
                    <div className="relative inline-flex items-center justify-center">
                        <svg className="w-32 h-32">
                            ...
                            <circle className="text-green-500" stroke="currentColor" strokeWidth="10" fill="none" r="56" cx="64" cy="64" 
                                style={{strokeDasharray: 351.86, strokeDashoffset: 140.744, transform: "rotate(-90 64 64)"}}/>
                        </svg>
                        <span className="absolute text-xl font-bold text-gray-700">60%</span>
                    ...
                    <div className="relative inline-flex items-center justify-center">
                        <svg className="w-32 h-32">
                            ...
                            <circle className="text-red-500" stroke="currentColor" strokeWidth="10" fill="none" r="56" cx="64" cy="64" 
                                style={{strokeDasharray: 351.86, strokeDashoffset: 281.488, transform: "rotate(-90 64 64)"}}/>
                        </svg>
                        <span className="absolute text-xl font-bold text-gray-700">20%</span>
